...
import gothpy_django_ex as app
...
tests_require = read('gothpy_django_ex/requirements/testing.pip')
...
setup(
    ...
    dependency_links=[],
    install_requires=read('gothpy_django_ex/requirements/install.pip'),
