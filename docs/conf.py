...
htmlhelp_basename = 'gothpy_django_ex'
...
latex_documents = [
    ('index', 'gothpy_django_ex.tex', u"Gothpy_Django_Ex Documentation",
...
man_pages = [
    ('index', 'gothpy_django_ex', u"Gothpy_Django_Ex Documentation",
     [u'Julien Aubert'], 1)
]
